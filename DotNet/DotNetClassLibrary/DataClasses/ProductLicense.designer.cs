...
{                            
    public partial class ProductLicense
    {
        ...
        [JsonProperty(DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate, PropertyName = "ProductLisences_ABSUsersesExpanded")]
        public BindingList<ABSUser> ProductLisences_ABSUsersExpanded { get; set; }
            
        [JsonProperty(DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate, PropertyName = "ProductLicenses_ABSUsersesExpanded")]
        public BindingList<ABSUser> ProductLicenses_ABSUsersExpanded { get; set; }
        ...
        [JsonProperty(DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate, PropertyName = "ProductLicenses_LicenseBundlesesExpanded")]
        public BindingList<LicenseBundle> ProductLicenses_LicenseBundlesExpanded { get; set; }
            
        [JsonProperty(DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate, PropertyName = "LicenseeEmailAddresses_LicenseBundlesesExpanded")]
        public BindingList<LicenseBundle> LicenseeEmailAddresses_LicenseBundlesExpanded { get; set; }
            
        [JsonProperty(DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate, PropertyName = "ProductLicenses_BundleSKUsesExpanded")]
        public BindingList<BundleSKU> ProductLicenses_BundleSKUsExpanded { get; set; }
