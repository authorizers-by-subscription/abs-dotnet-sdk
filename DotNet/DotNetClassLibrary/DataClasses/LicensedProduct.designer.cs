...
{                            
    public partial class LicensedProduct
    {
        ...
        [JsonProperty(DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate, PropertyName = "LicensedProducts_ProductBundlesesExpanded")]
        public BindingList<ProductBundle> LicensedProducts_ProductBundlesExpanded { get; set; }
            
        [JsonProperty(DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate, PropertyName = "Products_ABSUsersesExpanded")]
        public BindingList<ABSUser> Products_ABSUsersExpanded { get; set; }
