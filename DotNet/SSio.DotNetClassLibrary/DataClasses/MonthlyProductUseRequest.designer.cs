...
{                            
    public partial class MonthlyProductUseRequest
    {
        ...
        [JsonProperty(DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate, PropertyName = "MonthlyProductUseRequests_SSioUsersesExpanded")]
        public BindingList<SSioUser> MonthlyProductUseRequests_SSioUsersExpanded { get; set; }
