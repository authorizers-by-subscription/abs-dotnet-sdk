...
{                            
    public partial class ProductUseRequest
    {
        ...
        [JsonProperty(DefaultValueHandling = DefaultValueHandling.IgnoreAndPopulate, PropertyName = "ProductUseRequests_SSioUsersesExpanded")]
        public BindingList<SSioUser> ProductUseRequests_SSioUsersExpanded { get; set; }
